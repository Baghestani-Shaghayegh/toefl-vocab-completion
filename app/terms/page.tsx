...
<div data-custom-class="subtitle"><strong>Last updated</strong> May 03, 2026</div>
<br/>
<h2>AGREEMENT TO OUR LEGAL TERMS</h2>
<p>We are <strong>Lexivo</strong>, doing business as <strong>Lexivo</strong> ("Company," "we," "us," "our").</p>
<p>We operate the website <a href="https://www.lexivo.io" target="_blank">https://www.lexivo.io</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
<p>You can contact us by email at <a href="mailto:support@lexivo.io">support@lexivo.io</a>, or by mail to South Korea.</p>
<p>These Legal Terms constitute a legally binding agreement made between you and Lexivo, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
<p>We will provide you with prior notice of any scheduled changes to the Services. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:support@lexivo.io">support@lexivo.io</a>. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
...
<a href="#prohibited">6. Prohibited Activities</a>
<a href="#ugc">7. User Generated Contributions</a>
<a href="#license">8. Contribution License</a>
<a href="#advertisers">9. Advertisers</a>
<a href="#sitemanage">10. Services Management</a>
<a href="#ppyes">11. Privacy Policy</a>
<a href="#terms">12. Term and Termination</a>
<a href="#modifications">13. Modifications and Interruptions</a>
...
<a href="#electronic">21. Electronic Communications</a>
<a href="#california">22. California Users and Residents</a>
<a href="#misc">23. Miscellaneous</a>
...
<p>The Services are not tailored to comply with industry-specific regulations (HIPAA, FISMA, etc.), so if your interactions would be subjected to such laws, you may not use the Services. You may not use the Services in a way that would violate the Gramm-Leach-Bliley Act (GLBA).</p>
...
<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section, please address your request to: <a href="mailto:support@lexivo.io">support@lexivo.io</a>.</p>
...
<p>You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. We may change prices at any time. We reserve the right to refuse any order placed through the Services.</p>
...
<h2 id="ugc">7. User Generated Contributions</h2>
<p>The Services does not offer users to submit or post content. Any use of the Services in violation of these Legal Terms may result in termination or suspension of your rights to use the Services.</p>

<h2 id="license">8. Contribution License</h2>
...
<p>We allow advertisers to display their advertisements and other information in certain areas of the Services. We simply provide the space to place such advertisements, and we have no other relationship with advertisers.</p>
...
<p>We care about data privacy and security. Please review our Privacy Policy at <a href="https://lexivo.io/privacy" target="_blank">https://lexivo.io/privacy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in South Korea.</p>
...
<p>These Legal Terms shall be governed by and defined following the laws of South Korea. Lexivo and yourself irrevocably consent that the courts of South Korea shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
...
<p>Any dispute arising out of or in connection with these Legal Terms shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber according to the Rules of this ICAC. The number of arbitrators shall be one (1). The seat of arbitration shall be Seongnam, South Korea. The language of the proceedings shall be English. The governing law shall be substantive law of South Korea.</p>
<h3>Restrictions</h3>
<p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public.</p>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .paper-content [data-custom-class="subtitle"] {
          font-family: 'Special Elite', cursive;
          font-size: 14px;
          color: #aaa;
          margin-bottom: 32px;

      ...
      <div className="privacy-wrap">
        ...
        <div className="paper-card">
          <div className="paper-content">
            ...
            <p>
              This Privacy Notice for <strong>Lexivo</strong> ("we," "us," or "our"), describes how
            ...
            <p>
              ...
              information from Google when you use Google Sign-In.
            </p>
            <p>
            ...
            <p>
              ...
              rights is by contacting us at <a href="mailto:support@lexivo.io">support@lexivo.io</a>
            ...
            <p>
              <strong>Personal information provided by you</strong> includes: names, email
              addresses, and practice session data (scores, answers, time spent).
            </p>
            <p>
            ...
            <p>
              ...
              register using your Google account details. If you choose to register in this way, we
              will collect the information described in the section "How Do We Handle Your Social
              Logins?" below.
            </p>
            <p>
            ...
            <p>
              ...
              country, location, and information about how and when you use our Services. This
            ...
            <ul>
              ...
              <li>
                ...
                which case we will require those affiliates to honor this Privacy Notice.
              </li>
              <li>
            ...
            <p>
              Specifically, we use cookies to maintain your login session via Supabase Auth. These
              are essential cookies required for the service to function.
            </p>
            ...
            <p>
              ...
              from Google. The profile information we receive may include your name, email address,
              and profile picture.
            </p>
            <p>
              ...
              other uses of your personal information by Google. We recommend that you review
              Google's privacy policy to understand how they collect, use, and share your personal
              information.
            </p>
            <p>
            ...
            <p>
              Our servers are located in various regions via Supabase infrastructure. Regardless of
              your location, please be aware that your information may be transferred to, stored by,
              and processed by us in our facilities and in the facilities of the third parties with
              whom we may share your personal information, including facilities in South Korea and
              other countries.
            </p>
            <p>
              If you are a resident in the European Economic Area (EEA), United Kingdom (UK), or
              Switzerland, please be aware that these countries may not have data protection laws as
              comprehensive as those in your country. However, we will take all necessary measures
              to protect your personal information in accordance with this Privacy Notice and
              applicable law.
            </p>
            ...
            <p>
              ...
              of age. By using the Services, you represent that you are at least 18 years old. If we
            ...
            <p>
              ...
              time. You can withdraw your consent at any time by contacting us at{" "}
              <a href="mailto:support@lexivo.io">support@lexivo.io</a>.
            </p>
            <h3>Account Information</h3>
            <p>
              If you would at any time like to review or change the information in your account or
              terminate your account, you can contact us at{" "}
              <a href="mailto:support@lexivo.io">support@lexivo.io</a>.
            </p>
            <p>
            ...
            <p>
              ...
              indicated by an updated "Last updated" date at the top of this Privacy Notice. If we
